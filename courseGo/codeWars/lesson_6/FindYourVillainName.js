...
/*Create a function, getVillainName, that returns a villain name based on the user's birthday. (The birthday will be passed to the function as a valid Date object, so for simplicity, there's no need to worry about converting strings to dates.)
 ...
 FUNDAMENTALSARRAYSFUNCTIONSCONTROL FLOW*/

function getVillainName(birthday) {
    var mouths = ['The Evil', 'The Vile', 'The Cruel', 'The Trashy', 'The Despicable', 'The Embarrassing', 'The Disreputable',
        'The Atrocious', 'The Twirling', 'The Orange', 'The Terrifying', 'The Awkward'];
    var daysList = ['Mustache', 'Pickle', 'Hood Ornament', 'Raisin', 'Recycling Bin', 'Potato', 'Tomato', 'House Cat',
        'Teaspoon', 'Laundry Basket'];
    var mountString = mouths[birthday.getMonth()];

    var day = birthday.getDate();
    var dayString = daysList[day.toString().slice(-1)];

    return mountString + ' ' + dayString;
}

var date = new Date(1994, 03, 18);
